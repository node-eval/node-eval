...
describe('commonJS modules', () => {
    ...
    it('should eval exports number', () => coco('exports = 42; ({1:1, 2:2});').eql(42));

    it('should eval exports bool', () => coco('exports = true; ({1:1, 2:2});').eql(true));

    it('should eval exports string', () => coco('exports = \'42\'; ({1:1, 2:2});').eql('42'));

    it('should eval exports undefined', () => coco('exports = undefined; ({1:1, 2:2});').eql(undefined));

    it('should eval exports {}', () => coco('exports = {}; ({1:1, 2:2});').eql({}));

    it('should eval exports replace', () => coco('exports = {42:42, 24:24, 1:1}; ({1:1, 2:2});').eql({42: 42, 24: 24, 1: 1}));
